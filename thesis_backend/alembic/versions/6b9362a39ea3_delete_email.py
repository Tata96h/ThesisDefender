...
Revision ID: 6b9362a39ea3
Revises: 0bf685705413
Create Date: 2024-06-25 13:35:55.948138
...
revision = '6b9362a39ea3'
down_revision = '0bf685705413'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_constraint('utilisateur_email_key', 'utilisateur', type_='unique')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('utilisateur', sa.Column('email', sa.VARCHAR(length=200), autoincrement=False, nullable=True))
